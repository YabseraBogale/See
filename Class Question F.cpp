...
int main(){
	...
	// in file
	cout<<"Name: "<<of_book.Book.give_Name()<<endl;
	cout<<"ID: "<<of_book.Book.give_ID()<<endl;
	cout<<"price 1: "<<of_book.givep1()<<endl;
	cout<<"price 2: "<<of_book.givep2()<<endl;
	cout<<"price 3: "<<of_book.givep2()<<endl;
	cout<<"Average: "<<of_book.giveavaerage()<<endl;
